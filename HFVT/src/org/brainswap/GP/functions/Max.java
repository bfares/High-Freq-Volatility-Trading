...
/**
 * Defines a Max Fct that computes the Max of the provided data over an n period of time.
 ...
 * @see DoubleERC
 */
public class Max extends Literal {
	 ...
	 */
	public Max(dataType type, ArrayList<Double> data, final RandomNumberGenerator rng, final int lower, final int upper) {
		super(null);
		this.type= type;
		this.data=data;
...
//		// Set its value.
	...
	public Max newInstance() {
		final Max erc = (Max) super.newInstance();
		this.period= generateValue();
