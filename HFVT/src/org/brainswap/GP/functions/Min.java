...
/**
 * Defines a Min Fct that computes the Min of the provided data over an n period of time.
 ...
 * @see DoubleERC
 */
public class Min extends Literal {
	 ...
	 */
	public Min(dataType type, ArrayList<Double> data, final RandomNumberGenerator rng, final int lower, final int upper) {
		super(null);
	 ...
	 */
	@Override
	public Min newInstance() {
		final Min erc = (Min) super.newInstance();
		this.period= generateValue();
