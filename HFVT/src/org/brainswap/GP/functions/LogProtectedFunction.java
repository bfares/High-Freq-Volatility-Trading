 ...
 * @see Log10Function
 */
public class LogProtectedFunction extends Node {
	private double protectionvariable=0.0;

	/**
	 * Constructs a LogProtectedFunction with one <code>null</code> child.
	 */
	public LogProtectedFunction() {
		this(null);
	}
	 ...
	 */
	public LogProtectedFunction(final Node child) {
		super(child);
	}
