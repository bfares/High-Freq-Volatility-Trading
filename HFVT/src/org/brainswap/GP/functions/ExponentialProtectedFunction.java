...
private double protectionValue=0.0;
	 ...
	 */
	public ExponentialProtectedFunction(final Node exponent) {
		super(exponent);
	}
   ...
   if(Math.abs(NumericUtils.asDouble(c))>20)
