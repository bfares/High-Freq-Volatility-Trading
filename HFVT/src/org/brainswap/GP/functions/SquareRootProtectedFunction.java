 ...
 * called SQRT.
 */
public class SquareRootProtectedFunction extends Node {

	/**
	 * Constructs a SquareRootFunction with one <code>null</code> child.
	 */
	public SquareRootProtectedFunction() {
		this(null);
	}
	 ...
	 */
	public SquareRootProtectedFunction(final Node child) {
		super(child);
	}
	...
	public Double evaluate() {
		...
		return Math.sqrt(Math.abs(NumericUtils.asDouble(c)));
	}
