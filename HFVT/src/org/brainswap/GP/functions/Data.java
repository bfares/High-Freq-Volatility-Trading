...
/**
 * Defines a Fct that returns the data at position n.
 * n is an integer ephemeral random constant (ERC).
 ...
 * @see DoubleERC
 */
public class Data extends Literal {
	 ...
	 */
	public  Data(dataType type,  ArrayList<Double> data, final RandomNumberGenerator rng, final int lower, final int upper) {
		super(null);
		this.type=type;
		this.data= data;
	...
	public  Data newInstance() {
		final  Data erc = (Data) super.newInstance();
		this.period= generateValue();
